...
async function officialSearch(key: string) {
  const searchBase = isServer ? searchBaseURL.wySearch : searchBaseURL.wySearch.replace("https://music.163.com", "/api/wy");
  const detailsBase = isServer ? searchBaseURL.wyDetails : searchBaseURL.wyDetails.replace("https://music.163.com", "/api/wy");
...
async function officialFetch(id: string) {
  ...
  const target_url = isServer ? mediaBaseURL.wyOfficial : mediaBaseURL.wyOfficial.replace("https://music.163.com", "/api/wy");
